...
import { TextField, Typography, Box, Button, Stack, TextareaAutosize } from '@mui/material'
...
export default function ChildTrainingCustomize(props) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('storeChildTrainingPost'),data); 
    }


  return (
    <Authenticated auth={props.auth} errors={props.errors}>
        <Head title='Post child training' />
        <Container maxWidth="md">
            <Typography variant='h6' gutterBottom>Edit Child Training page</Typography>
            <Box sx={{ padding: 2, width: "100%", borderRadius: 3, backgroundColor: '#cfaaf7' }}>

                {/* If admin select a photo, App photo button disappear  */}
