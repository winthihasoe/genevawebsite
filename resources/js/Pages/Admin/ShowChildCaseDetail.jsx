...
export default function ShowChildCaseDetail(props) {
                ...
                <Paper elevation={12} sx={{ p: 4, mt:2 }}>
                    ...
                    <>
                        ...
                        <Box sx={{ m: 2 }}>
                            ...
                            <Typography variant='p' gutterBottom>Baby Age: {caseDetail.patient_age == 1 && '0 - 1 month' } {caseDetail.patient_age == 3 && '1 - 3 month' } {caseDetail.patient_age == 6 && '3 - 6 month' } {caseDetail.patient_age == 12 && '6 - 12 month' } {caseDetail.patient_age == 13 && 'more than 1 year' }</Typography>
