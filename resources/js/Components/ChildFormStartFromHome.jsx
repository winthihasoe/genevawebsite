...
import ChildCareTopicsStartFromHome from "./ChildCareTopicsStartFromHome";

export class ChildFormStartFromHome extends Component {
...
export default ChildFormStartFromHome;
