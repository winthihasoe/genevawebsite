...
import "../../css/app.css";
import SidebarForTrainingOfficer from "@/Components/SidebarForTrainingOfficer";

export default function TrainingOfficer({ auth, children }) {
            ...
            <nav>
                ...
                >
                    <div className="pt-2 pb-2 space-y-1">
                        <ResponsiveNavLink
                            href={route("trainingOfficerPage")}
                            active={route().current("trainingOfficerPage")}
                        >
                            Dashboard
                        </ResponsiveNavLink>
                    </div>
